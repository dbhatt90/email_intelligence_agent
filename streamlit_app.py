...
def render_about_tab():
    ...
    An AI-powered tool that analyzes promotional emails to extract marketing insights.
    
    ### Features
    
    - **Discount Analysis**: Track pricing trends and identify best deals
    - **Urgency Detection**: Identify manipulative marketing tactics
    - **Brand Comparison**: Compare strategies across brands
    - **Timing Insights**: When do brands send emails?
    ...
    2. Agent analyzes your email data
    3. Get insights and visualizations
    4. Explore brand statistics
...
def render_chat_tab():
    ...
    if not st.session_state.current_session_id:
        st.info("👈 Start a new conversation by typing below or select a quick start question!")
...
def main():
    ...
    # Create tabs - Streamlit handles the active tab automatically
    tab_about, tab_overview, tab_chat, tab_explorer = st.tabs([
        "ℹ️ About", 
        "📊 Overview", 
        "💬 Chat", 
        "🔍 Data Explorer"
    ...
    # Render all tabs - Streamlit will only display the active one
    with tab_about:
        render_about_tab()
